...
public abstract class ClassLoaderUtils {
    ...
    private static class ReflectionClassDefiner implements ClassDefiner {
        ...
        private ReflectionClassDefiner() throws NoSuchMethodException {
    ...
    private static class ReflectionPackagesFetcher implements ClassLoaderPackagesFetcher {
        ...
        static {
            GET_PACKAGES_METHOD = JavaMethod.of(ClassLoader.class, Package[].class, "getPackages");
        }

        private static final JavaMethod<ClassLoader, Package> GET_PACKAGE_METHOD;

        static {
            GET_PACKAGE_METHOD = JavaMethod.of(ClassLoader.class, Package.class, "getPackage", String.class);
        }
