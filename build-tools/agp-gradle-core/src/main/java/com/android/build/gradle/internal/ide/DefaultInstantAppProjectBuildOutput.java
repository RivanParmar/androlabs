...
/** Default implementation of the minimal instantApp project outputs. */
public class DefaultInstantAppProjectBuildOutput
    ...
    DefaultInstantAppProjectBuildOutput(
            ImmutableList<InstantAppVariantBuildOutput> variantBuildOutputs) {
