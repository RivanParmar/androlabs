    ...
    private fun registerTasks(
        ...
        project.afterEvaluate {
            ...
            val kotlinExtensionWrapper = try {
                ...
                // TODO: Modified
                val forName = Class.forName("org.jetbrains.kotlin.gradle.dsl.KotlinMultiplatformExtension")
//                val kotlinExtension =
...
//                kotlinExtension?.let { KotlinMultiplatformExtensionWrapper(it) }
                ...
                kotlinExtension?.let { forName.isAssignableFrom(it.javaClass) }
